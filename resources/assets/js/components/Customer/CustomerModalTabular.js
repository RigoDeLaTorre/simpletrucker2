...
import { deleteCustomer } from "../../actions/customer/deleteCustomer.js";
...
class CustomerModalTabular extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tab: "profile"
  ...
  handleDelete = () => {
    let id = this.props.customers.selectedCustomer.id;

    if (
      confirm(
        "Are You sure you want to delete this Customer and ALL related Loads ?"
      ) == true
    ) {
      this.props.deleteCustomer(id, message => {
        if (message.success) {
          M.toast({
            html: message.success,
            classes: "materialize__toastUpdated"
          });
          document.getElementById("closeCustomerModalTabular").click();
        } else {
          M.toast({
            html: message.error,
  ...
  render() {
    ...
    return (
      <div id="modal1" className="modal modal-fixed-footer modal-customer">
        <div className="modal-content">
          <ul className="tabs tabs__accountingEdit">
            ...
            <li className="tab tab__accountingEdit tab__accountingEdit--red">
              <a href="#test4">Delete Customer</a>
            </li>
          </ul>
          ...
          >
            ...
            <div id="test4" className="col s12 deleteLoad">
              <div className="form__section form__section--accounting">
                <p>
                  To permanently delete this Customer and all related Loads,
                  click the delete button below. This will be permanent.
                  <br />
                  It will ask you to confirm the deletion.
                </p>

                <h4 className="deleteLoad__button" onClick={this.handleDelete}>
...
CustomerModalTabular = reduxForm({
  form: "CustomerView",
  initialized: true,
...
CustomerModalTabular = connect(
  ...
  { updateCustomer, deleteCustomer } // bind account loading action creator
)(CustomerModalTabular);

export default CustomerModalTabular;
