...
class ExpenseViewModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tab: "expense",
  ...
  handleDelete = () => {
    let id = this.props.expense.selectedExpenseRecord.id;

    if (confirm("Are You sure you want to delete this Expense ?") == true) {
      this.props.deleteExpenseRecord(id, message => {
        if (message.success) {
          M.toast({
            html: message.success,
            classes: "materialize__toastUpdated"
          });
          document.getElementById("modalExpenseView").click();
        } else {
          M.toast({
            html: message.error,
  ...
  render() {
    return (
      <div
        id="expenseRecordEdit"
        className="modal modalExpenseView modal-fixed-footer load-modal"
      >
        <div className="modal-content">
          <ul className="tabs tabs__accountingEdit">
            ...
            <li className="tab tab__accountingEdit tab__accountingEdit--red">
              <a href="#expenseViewTab5">Delete Expense</a>
            </li>
          </ul>
          ...
          <form className="form">
            ...
            <div id="expenseViewTab5" className="col s12 deleteLoad">
              <div className="form__section form__section--accounting">
                <p>
                  To permanently delete this expense, click the delete button
                  below.
                  <br />
...
ExpenseViewModal = reduxForm({
  form: "ExpenseViewModal",
  initialized: true,
