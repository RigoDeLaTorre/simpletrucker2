      ...
      return (
        <li key={pickup.id}>
          <div className="collapsible-header modal__collapsibleHeader modal__collapsibleHeader--pickup">
            ...
            {index + 1} :{pickup.pickup_date} - {pickup.pickup_city} ,{" "}
            {pickup.pickup_state}
          </div>
          <div className="collapsible-body modal__collapsibleBody">
            <h4>
              Pickup #{index + 1} : {pickup.pickup_date}
            </h4>
      ...
      return (
        <li key={delivery.id}>
          <div className="collapsible-header modal__collapsibleHeader modal__collapsibleHeader--delivery">
            ...
            {index + 1} :{delivery.delivery_date} - {delivery.delivery_city},{" "}
            {delivery.delivery_state}
          </div>
          <div className="collapsible-body modal__collapsibleBody">
            <h4>
              Delivery #{index + 1} : {delivery.delivery_date}
            </h4>
    ...
    return (
      <div>
        ...
        !this.props.loads.selectedLoad.deliveries ? (
          ...
          <div className="modal-content load-modal load-view-mobile">
            <div className="modal__topBar">
              <div>
                <h4 className="modal__topBar__text">
                  Invoice
                  <br /> #{this.props.loads.selectedLoad.invoice_id}
                </h4>
              </div>
              <div className="modal__topBar__middleSection">
                ...
                <div className="modal__topBar__displayNumberofDrops">
                  <h4 className="modal__topBar__text modal-content__h4 modal__topBar__pickupanddrops">
            ...
            <ul className="tabs tabs__accountingEdit">
              <li className="tab tab__accountingEdit">
                <a
                  ...
                  href="#test1"
                  onClick={() => this.setState({ tab: "load" })}
                >
                  Load
                </a>
              </li>
              <li className="tab tab__accountingEdit">
                <a
                  ...
                  href="#test2"
                  onClick={() => this.setState({ tab: "process" })}
                >
                  Process Load
                </a>
              </li>
